...
import com.altimetrik.ccigit.filter.ApiOriginFilter;
...
@EntityScan("com.altimetrik.ccigit.model")
@EnableJpaRepositories("com.altimetrik.ccigit.model.repository")
